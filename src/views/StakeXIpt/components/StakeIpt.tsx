...
const StakeIpt: React.FC<StakeProps> = ({}) => {
  const tokenName = "IPT"
  ...
  const tokenBalance = useTokenBalance(contractAddresses.ipt[1])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`IPT Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
